            ...
            new DialogInterface.OnClickListener() {
                    ...
                    switch (which) {
                        case 0: // Take picture
                            ...
                            if (mMediaUri == null) {
                                // Display an error
                                Toast.makeText(
                                    MainActivity.this, R.string.error_external_storage,
                        ...
                        case 3:  // Choose video
                            ...
                            Toast.makeText(MainActivity.this,
                                    getString(R.string.video_file_size_warning), Toast.LENGTH_LONG)
                                    .show();
                ...
                private Uri getOutputMediaFileUri(int mediaType) {
                    ...
                    if (isExternalStorageAvailable()) {
                        ...
                        File mediaFile;
                        Date now = new Date();
                        String timestamp = new SimpleDateFormat("yyyyMMdd_HHmmss", new Locale("be"))
                                .format(now);
